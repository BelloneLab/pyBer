...
class InvertedIsobesticFitTests(unittest.TestCase):
    def test_helper_fits_negative_reference_before_dff(self):
        ...
        manual_slope, manual_intercept = ac.fit_reference_to_signal(-ref, sig, params)
    ...
    def test_process_trial_exposes_inverted_mode(self):
        fs = 40.0
        ...
        params = ac.ProcessingParams()
        params.output_mode = INVERTED_FIT_MODE
